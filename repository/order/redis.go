...
import (
	...
	"github.com/Dostonlv/orders-api/model"
...
var ErrNotExist = errors.New("order does not exists")
...
func (r *RedisRepo) FindByAll(ctx context.Context, page FindAllPage) (FindResult, error) {
